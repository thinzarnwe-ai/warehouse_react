  ...
  return (
    <form onSubmit={handleSubmit} className="p-5 bg-gray-100">
      ...
      <div className="grid grid-cols-2 md:w-3/4 mx-auto  gap-5 bg-white p-5 rounded-xl shadow">
        ...
        <LocationScanner form={form} setForm={setForm} startScan={startScan} />

        <ProductSearch form={form} setForm={setForm} selectedBranch={selectedBranch} startScan={startScan} />
